      ...
      <div className="container mx-auto px-6 py-4 relative">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8 absolute left-1/2 transform -translate-x-1/2">
            <a
              href="#tours"
              className="text-monastery-earth hover:text-monastery-gold transition-zen"
            >
              Virtual Tours
            </a>
            <a
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4 border-t border-monastery-stone/30 pt-4">
            <div className="flex flex-col space-y-4">
              <a
                href="#tours"
                className="flex items-center space-x-2 text-monastery-earth hover:text-monastery-gold transition-zen"
              >
